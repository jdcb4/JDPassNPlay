...
- `src/components` — shared UI (`GameShell`, `GameResultActions`, `AppInfoOverlay`, `game/` panels, `GameScoreboard`, footer buttons, `EditableName`, `Metric`, `setup/`, `team-setup/`, `ui/button`).
